...
const PYRUS_LOGIN = process.env.PYRUS_BOT_LOGIN || process.env.PYRUS_LOGIN;
const PYRUS_SECURITY_KEY = process.env.PYRUS_BOT_KEY || process.env.PYRUS_SECURITY_KEY;
